...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#equal, #notEqual', function () {
      ...
      assert.notEqual(6 + '2', '12', '+ operator concatenates as if they were strings');
    });
    // #6
    test('#strictEqual, #notStrictEqual', function () {
      assert.notStrictEqual(6, '6', "they are different types");
  ...
  suite('Arrays', function () {
    ...
    test('Array #include, #notInclude', function () {
      assert.notInclude(winterMonths, 'jul', "It's summer in july in the south hemisphere");
  ...
  suite('Objects', function () {
    ...
    test('#typeOf, #notTypeOf', function () {
      assert.typeOf(myCar, 'object', "myCar is of type Object");
